      ...
      <section className="space-y-8">
        ...
        {favorites.length === 0 ? (
          <div className="bg-surface rounded-sm p-12 text-center border border-line">
            <Heart className="w-10 h-10 text-gold/10 mx-auto mb-4" />
            <p className="text-muted italic text-sm">Your bookmarks are currently empty.</p>
            <Link to="/search" className="text-gold text-xs font-bold uppercase tracking-widest mt-4 inline-block hover:underline">Explore Catalog</Link>
          </div>
        ) : (
